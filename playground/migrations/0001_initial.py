# Generated by Django 4.2.1 on 2023-09-17 05:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(max_length=100)),
                ('matricule', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='playground.agent')),
                ('mois_abonnement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reexpedition_mois_abonnement', to='playground.prixboitereexpedition')),
                ('num_panier', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='playground.panier')),
                ('type_activite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='playground.activite')),
                ('type_expediteur', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reexpedition_type_expediteur', to='playground.prixboitereexpedition')),
            ],
        ),
        migrations.CreateModel(
            name='Recu',
